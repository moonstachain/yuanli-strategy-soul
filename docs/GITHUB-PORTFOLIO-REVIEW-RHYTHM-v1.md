...
Status: split review PR / dashboard + review rhythm spec

## Purpose

Connect GitHub Portfolio Governance to CBM-PMO dashboard rhythm.
...
| l1_core_governance_count | repos marked L1 | registry |
| l2_capability_asset_count | repos marked L2 | asset pool |
...
## Dashboard Patch Plan

### Patch `docs/cbm-capability-cockpit-data.js`
...
### Patch `docs/pmo-dashboard-data.js`
