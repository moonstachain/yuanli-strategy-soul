window.YUANLI_PMO_V22={
  version:'v2.4',
  sync:{mode:'github_actions',source:'issues',updated_at:'2026-06-30T03:50:00Z'},
  ...
  views:[
    ...
    {id:'roadmap',name:'Roadmap / Milestone',layout:'roadmap',purpose:'manage release sequence',milestones:['v2.2 PMO OS','v2.3 C3 Gap Ranking','v2.4 PMO Automation Bridge','v2.5 PMO Dashboard','v3.0 Agent Execution Bridge']}
  ],
  ...
  automation:['issue changed -> sync dashboard','c3-gap -> ready','c4-task -> todo','pr opened -> in_progress','pr merged -> done','evidence added -> weak+','evolution added -> writeback complete','blocked 7d -> red'],
  seed_items:[
    ...
    {issue:'#65',node:'C2',type:'evidence',domain:'data',layer:'validation',status:'qa',health:'green',priority:'P1',gap_score:50,evidence:'medium',next:'review v2.4 sync evidence'}
  ],
  gap_ranking:[
    {rank:1,issue:'#63',gap:'matrix design gap ranking',score:72,formula:'parsed from issue body',selected:true,next_issue:'#64'}
  ]
};
