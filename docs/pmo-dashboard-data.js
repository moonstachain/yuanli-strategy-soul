window.YUANLI_PMO_V22={
  ...
  "sync": {
    ...
    "updated_at": "2026-06-30T16:03:52.098Z"
  },
  "fields": [
    "Canon Node",
    "Work Type",
  ...
  "seed_items": [
    ...
    },
    {
      ...
      "gap_score": 50,
      "evidence": "medium",
      "next": "把过去 6 个月所有有更新的 GitHub 仓库，从“活跃 repo 列表”升级为 CBM-PMO ���值审计注册表，判断每个项目是否具备战略地图价值、能力资产价值、客户证据价值、内容增长价值、工程复用价值，或仅应观察 / 归档候选。"
    },
    {
      "issue": "#149",
      "node": "C4",
