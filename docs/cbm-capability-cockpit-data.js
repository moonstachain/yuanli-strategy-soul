window.YUANLI_CBM_CAPABILITY_COCKPIT = {
  version: 'v1.2-auto-sync-contract-ready',
  ...
  system_health: { total_cells: 18, draft_cells: 3, validated_cells: 0, operating_cells: 0, compounding_cells: 0, medium_evidence_cells: 3, weak_evidence_cells: 15, backwrite_coverage: '3/18', false_green_risks: 0, current_stage: 'Auto Sync Contract Ready', next_p0_capability: 'first-strong-or-repeated-evidence' },
  ...
  top_gaps: [
    { rank: 1, cbm_cell_id: 'client.control.project-portfolio-governance', gap_score: 66, reason: 'No real client-side confirmation or repeated project metric exists yet.', next: 'Run first real or further anonymized client-project weekly review input.' },
    { rank: 2, cbm_cell_id: 'engineering.execute.operator-skill-reuse', gap_score: 64, reason: 'Sync contract exists, but no live script-backed repeated run yet.', next: 'Run sync checker and weekly generator as repeatable workflow.' },
    { rank: 3, cbm_cell_id: 'strategy.direct.os-governance-core', gap_score: 54, reason: 'Governance rules are defined and protected by contract, but not yet used in repeated PMO rhythm.', next: 'Use P0 gate rules in next real P0 selection.' }
  ],
