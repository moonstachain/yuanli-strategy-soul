...
任何新任务不要直接丢给 Codex、不要直接进入具体仓、不要直接写页面。先在本仓开 Issue，完成：

```text
归属 → 边界 → 输出物 → 验收 → 回写
```

### 1.2 本仓是“任务中枢”，不是“所有代码堆积地”
...
任务入口说明
Codex 执行前对齐
未来 GitHub Pages / 静态网站发布
```

发布到网页时，可优先把 `docs/index.html` 作为首页。
